...
export function behaviorDrawJsonWay(context, wayId, index, mode, startGraph) {
    ...
    function isInvalidGeometry(entity, graph, finishDraw) {
        ...
        for (var i = 0; i < parents.length; i++) {
            ...
            var nodes = parent.nodes.map(function (nodeID) {
    ...
    var drawWay = function (surface) {
        console.log(' var drawWay = function(surface) in behaviorDrawWay')
        behavior
            .on('move', move)
    ...
    function _actionAddDrawNode() {
        ...
        return function (graph) {
            //console.log(origWay, context.entity(wayId))
            origWay = context.entity(wayId);
            return graph
                .replace(end)
